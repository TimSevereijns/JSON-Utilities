...
namespace json_utils
{
    ...
    namespace deserializer
    {
        namespace detail
        {
            ...
            auto
            to_key_value_pair(const rapidjson::GenericMember<EncodingType, AllocatorType>& member)
                    ...
                    std::pair<std::string, int>>::type
            {
                return std::make_pair<std::string, int>(
                    member.name.GetString(), member.value.GetInt());
            }
            ...
            template <typename ContainerType, typename EncodingType, typename AllocatorType>
            std::pair<std::string, ContainerType> construct_nested_pair(
